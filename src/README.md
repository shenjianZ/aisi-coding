...
#heroFullScreen: true
#heroText: 爱思文档
#tagline: 你可以在这里找到编程的乐趣和魅力,和我一起来吧!
...
#    highlights:
#      - title: 运行 <code>pnpm create vuepress-theme-hope hope-project.ts</code> 以创建一个新的主题项目。
...
projects:
  - icon: project.ts
    name: 前后端分离的模板项目
    desc: springboot3+vue3
    link: https://shenjianl.cn/front
